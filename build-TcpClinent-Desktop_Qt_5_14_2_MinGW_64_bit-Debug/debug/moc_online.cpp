...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_online_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_online_t qt_meta_stringdata_online = {
    {
QT_MOC_LITERAL(0, 0, 6), // "online"
QT_MOC_LITERAL(1, 7, 22), // "on_addfriendPB_clicked"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "online\0on_addfriendPB_clicked\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_online[] = {
...
void online::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_addfriendPB_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject online::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_online.data,
    qt_meta_data_online,
    qt_static_metacall,
    nullptr,
    nullptr
