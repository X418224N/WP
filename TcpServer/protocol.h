...
#define LOGIN_FAILED "lgoin failed:name or pwd or relogin"
...
#define DEL_FILE_OK "delete reg ok"
#define DEL_FILE_FAILURED "delete reg FAILURED"
...
enum ENUM_MSG_TYPE
{
    ...
    ENUM_MSG_TYPE_RENAME_FILE_RESPOND,//重命名录回复
    ENUM_MSG_TYPE_ENTER_DIR_REQUEST,//进入文件夹请求
    ENUM_MSG_TYPE_ENTER_DIR_RESPOND,//进入文件夹回复
    ENUM_MSG_TYPE_UPLOAD_FILE_REQUEST,//上传文件请求
    ENUM_MSG_TYPE_UPLOAD_FILE_RESPOND,//上传文件回复
    ENUM_MSG_TYPE_DEL_REG_REQUEST,//删除文件请求
    ENUM_MSG_TYPE_DEL_REG_RESPOND,//删除文件回复
    ...
    ENUM_MSG_TYPE_REMAKE_REQUEST,//注销账号请求
    ENUM_MSG_TYPE_REMAKE_RESPOND,//注销账号回复
